...
class _LanguageSelectorPageState extends State<LanguageSelectorPage> {
  ...
  getData() async {
    var resultText = await Internationalization.getTranslationObject(
        context, "language_selector_page");
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Image.asset(
                      Internationalization.iconAssetsPath[lang].toString()),
                ),
                Text(
                  Internationalization.languageNames[lang].toString(),
                  style: TextStyle(
                    decoration: TextDecoration.none,
                    color: lang == this.lang
                        ? ThemeColors.grayAccent[3]
                        : ThemeColors.defaultAccent[3],
