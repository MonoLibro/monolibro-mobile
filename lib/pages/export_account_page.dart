...
class _ExportAccountPageState extends State<ExportAccountPage>{
  ...
  getData() async {
    var result = await Internationalization.getTranslationObject(context, "export_account_page");
    setState(() {
      text = result;
    });
  }
      ...
      body: Stack(
        children: [
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    Image.network("https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=Example")
                  ],
                )
              )
            )
          ...
          Visibility(
            visible: showWarning,
            child: Center(
              child: buildWarningMessage(context)
            )
          ),
        ],
      ),
